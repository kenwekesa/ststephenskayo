...
//
//    val directory = File(Environment.getExternalStorageDirectory(), "StStephens")
//    if (!directory.exists()) {
//        directory.mkdirs()
//    }
//
//    // Check if the user has granted permission to write to external storage
//
...
fun MemberPaymentScreen(phoneNumber: String, password: String) {
    ...
    MemberPaymentView(viewModel = viewModel, phoneNumber = phoneNumber, password = password)
}
...
fun generateExcelSheet(payments: List<Paym>) {
    try {
       ...
       // val rootDirectory = Environment.getExternalStorageDirectory()
        ...
        val fileName = "example.xls"
        val filePath = File(stStephensDirectory, fileName).toString()
